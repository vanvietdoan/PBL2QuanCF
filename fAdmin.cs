...
namespace PBL2QuanCF
{
    public partial class fAdmin : Form
    {
        ...
        private void tpAdmin_SelectedIndexChanged_1(object sender, EventArgs e)
        {
        ...
        private void tpBill_Click_1(object sender, EventArgs e)
        {
        ...
        private void dtpkToDate_ValueChanged_1(object sender, EventArgs e)
        {

        }

        private void dtpkFromDate_ValueChanged_1(object sender, EventArgs e)
        {
        ...
        private void txbSearchFoodName_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void txbFoodName_TextChanged_1(object sender, EventArgs e)
        {
        ...
        private void tpFoodCategory_Click_1(object sender, EventArgs e)
        {

        }

        private void tpTable_Click_1(object sender, EventArgs e)
        {

        }

        private void tpAccount_Click_1(object sender, EventArgs e)
        {
        ...
        private void tpAdmin_SelectedIndexChanged_2(object sender, EventArgs e)
        {
